# -*- coding: utf-8 -*-
# ============================================================================
#  STAGE 3 OPERATIONAL SIMULATOR (Final Corrected Version)
# - 최종 수정 사항:
#   (1) KeyError: 'sku' 해결: carbon_factor_prod 데이터 구조에 맞게 CO2 계산 로직 수정
#   (2) 운송비: 컨테이너(4000unit) 단위로 산정
#   (3) 국경 통과비: '운송 건당' 고정비로 수정
#   (4) 환경부담금: 생산/운송 CO2 배출량 및 환경세(톤당 올림) 추가
#   (5) 운송 모드 변경 수수료: 4주 모드 고정 및 변경 페널티 로직 구현
#   (6) 초기 건설비: 총 비용에 합산
#   (7) 제출 형식(DB): 일일 생산량 집계 후 모든 행에 동일하게 기록
# ============================================================================
